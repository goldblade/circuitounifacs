<div class="container">
	...
	<div class="page-header">
		<h1>Atividades  <small>do evento X</small></h1>
	</div>	
	<div class="row">
		<div class="col-xs-12 col-md-9 col-sm-6">			
			<a href="/gerenciamento/eventos/save/usuario/1" class="btn btn-primary">
