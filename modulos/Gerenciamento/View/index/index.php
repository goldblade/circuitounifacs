<div class="container">
	...
	<div class="row-fluid">
		...
		<div class="col-md-3 col-sm-6">
			<div class="thumbnail">
				<a href="/gerenciamento/locais/index">
					<img data-src="holder.js/140x140" class="img-thumbnail" alt="140x140" src="data:image/svg+xml;base64," style="width: 140px; height: 140px;">
				</a>
				<div class="caption">
					<h3><a href="/gerenciamento/locais/index">Locais</a></h3>
				</div>			
			</div>
		...
		<div class="col-md-3 col-sm-6">
			<div class="thumbnail">
				<a href="/gerenciamento/inscritos/index">
					<img data-src="holder.js/140x140" class="img-thumbnail" alt="140x140" src="data:image/svg+xml;base64," style="width: 140px; height: 140px;">
				</a>
				<div class="caption">
					<h3><a href="/gerenciamento/inscritos/index">Inscritos</a></h3>
				</div>	
			</div>			
		</div>	
		<div class="col-md-3 col-sm-6">
			<div class="thumbnail">
				<a href="/gerenciamento/usuario/index">
					<img data-src="holder.js/140x140" class="img-thumbnail" alt="140x140" src="data:image/svg+xml;base64," style="width: 140px; height: 140px;">
				</a>
				<div class="caption">
					<h3><a href="/gerenciamento/usuario/index">Usuários</a></h3>
				</div>
			</div>			
		</div>	
	</div>	
